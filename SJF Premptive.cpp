...
int main()
{
      ...
      float atat=0,awt=0,stat=0,swt=0;            // atat=avg turnaround time , awt=avg waiting time
	...
	cout<<" Average turnaround  time="<<atat;  //average waiting time and turn around time
}
